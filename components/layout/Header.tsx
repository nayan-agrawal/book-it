...
const Header = () => {
    ...
    return (<nav className="navbar sticky-top py-2">
        <div className="container">
            ...
            <div className="col-6 col-lg-3 mt-3 mt-md-0 text-end">
                {data?.user ? (
                    ...
                    {data === undefined && (<div className="placeholder-glow">
                        <figure className="avatar avatar-nv placeholder bg-secondary"></figure>
                        <span className="placeholder w-25 bg-secondary m-2"></span>
                    </div>)}
                    {data === null  && (<Link href="/login" className="ms-2 btn btn-danger px-4 text-white login-header-btn flaot-right">
                        Login
                    </Link>)}
                </>)}
            </div>
